...
- Cobertura añadida después de la primera auditoría para cerrar gaps de documentación/pruebas: `test_router_eval_offline_warns_below_two_hundred_runs`, `test_local_router_reports_missing_prices_without_claiming_known_minimum` y `test_refresh_rate_fetches_and_persists_bcch_value`.
